    ...
    var DateRangePicker = function(element, options, cb) {
        ...
        if (typeof options.template !== 'string' && !(options.template instanceof $))
            options.template = '<div class="daterangepicker dropdown-menu">' +
                ...
                '<button class="applyBtn" disabled="disabled" type="button" style="background:#5f9bdb;border-color:#5f9bdb "></button> ' +
                '<button class="cancelBtn" type="button" style="margin-left: 40px"></button>' +
                // '<button class="clearBtn" type="button" style="margin-left:3px;">清空</button>' +
                '</div>' +
                '</div>' +
                '</div>';
        ...
        //console.log("test"+this.locale.clearLabel);
    ...
    DateRangePicker.prototype = {
        ...
        show: function(e) {
            ...
            if(this.container.css("position") == "fixed"){
                this.container.css("top",($(window).height()*0.5)+"px");
            }
