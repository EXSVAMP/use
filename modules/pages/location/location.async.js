...
var scope = ['$scope','$http','$timeout','$interval','$uibModal',"baseUrl","$sce","$templateCache","$location", function($scope, $http, $timeout, $interval, $uibModal,baseUrl,$sce,$templateCache,$location) {
